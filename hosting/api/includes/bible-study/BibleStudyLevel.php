...
{
  public const DEFAULT = 'formador';
  public const VALUES = ['pastoral','teologico','doctrinal','formador'];
  ...
  public static function config(string $level): array
  {
    ...
    $configs = [
      ...
      'formador' => [
        'label'=>'Formador','depth'=>'complete','style'=>'academic-pastoral',
        'focus'=>array_keys(BibleStudySchema::jsonSchema()['properties']),
  ...
  public static function prompt(string $level): string
  {
