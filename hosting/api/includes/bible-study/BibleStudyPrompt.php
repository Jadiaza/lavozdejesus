...
final class BibleStudyPrompt
{
  ...
  public static function system(string $method = BibleStudyMethod::DEFAULT, string $level = BibleStudyLevel::DEFAULT): string
  {
...
- En comparacion_traducciones y palabras_clave distingue coincidencia literal de equivalencia semántica. Atribuye una forma o característica a una traducción únicamente cuando esté literalmente presente en el texto de esa versión recibido por el sistema. No mezcles formas de Torres Amat y Scío. Trata diferencias como Asaf/Asá como posibles variantes textuales que requieren revisión, no como simples variantes ortográficas, salvo que los datos internos lo demuestren. Explica cuándo dos palabras diferentes expresan un concepto común y cuándo el cambio modifica el matiz teológico, poético o pastoral.
...
PROMPT
      . BibleStudyMethod::prompt($method)
      . BibleStudyLevel::prompt($level, $method);
  }
}
