...
try {
  ...
  $base = lvj_first(
    ...
    "SELECT
      ...
      apariencia.color_texto_secundario,
      apariencia.color_surface,
      apariencia.color_icono,
      apariencia.color_icono_activo,
      apariencia.color_icono_inactivo,
      apariencia.color_boton_primario_fondo,
      apariencia.color_boton_primario_texto,
      apariencia.color_boton_primario_borde,
      apariencia.color_boton_secundario_fondo,
      apariencia.color_boton_secundario_texto,
      apariencia.color_boton_secundario_borde,
      apariencia.color_nav_fondo,
      apariencia.color_nav_borde,
      apariencia.color_nav_icono_activo,
      apariencia.color_nav_icono_inactivo,
      apariencia.color_nav_texto_activo,
      apariencia.color_nav_texto_inactivo,
      apariencia.color_nav_indicador,
      apariencia.color_card_texto,
      apariencia.color_card_icono,
      apariencia.color_overlay,
      apariencia.overlay_opacidad,
      apariencia.color_input_fondo,
      apariencia.color_input_borde,
      apariencia.color_progress_fondo,
      apariencia.color_progress_relleno,
      apariencia.color_exito,
      apariencia.color_advertencia,
      apariencia.color_error,
      apariencia.color_info,
  ...
  lvj_json_response([
    ...
    'color_texto_secundario' => lvj_text($base, 'color_texto_secundario'),
    'color_surface' => lvj_text($base, 'color_surface'),
    'color_icono' => lvj_text($base, 'color_icono'),
    'color_icono_activo' => lvj_text($base, 'color_icono_activo'),
    'color_icono_inactivo' => lvj_text($base, 'color_icono_inactivo'),
    'color_boton_primario_fondo' => lvj_text($base, 'color_boton_primario_fondo'),
    'color_boton_primario_texto' => lvj_text($base, 'color_boton_primario_texto'),
    'color_boton_primario_borde' => lvj_text($base, 'color_boton_primario_borde'),
    'color_boton_secundario_fondo' => lvj_text($base, 'color_boton_secundario_fondo'),
    'color_boton_secundario_texto' => lvj_text($base, 'color_boton_secundario_texto'),
    'color_boton_secundario_borde' => lvj_text($base, 'color_boton_secundario_borde'),
    'color_nav_fondo' => lvj_text($base, 'color_nav_fondo'),
    'color_nav_borde' => lvj_text($base, 'color_nav_borde'),
    'color_nav_icono_activo' => lvj_text($base, 'color_nav_icono_activo'),
    'color_nav_icono_inactivo' => lvj_text($base, 'color_nav_icono_inactivo'),
    'color_nav_texto_activo' => lvj_text($base, 'color_nav_texto_activo'),
    'color_nav_texto_inactivo' => lvj_text($base, 'color_nav_texto_inactivo'),
    'color_nav_indicador' => lvj_text($base, 'color_nav_indicador'),
    'color_card_texto' => lvj_text($base, 'color_card_texto'),
    'color_card_icono' => lvj_text($base, 'color_card_icono'),
    'color_overlay' => lvj_text($base, 'color_overlay'),
    'overlay_opacidad' => lvj_text($base, 'overlay_opacidad'),
    'color_input_fondo' => lvj_text($base, 'color_input_fondo'),
    'color_input_borde' => lvj_text($base, 'color_input_borde'),
    'color_progress_fondo' => lvj_text($base, 'color_progress_fondo'),
    'color_progress_relleno' => lvj_text($base, 'color_progress_relleno'),
    'color_exito' => lvj_text($base, 'color_exito'),
    'color_advertencia' => lvj_text($base, 'color_advertencia'),
    'color_error' => lvj_text($base, 'color_error'),
    'color_info' => lvj_text($base, 'color_info'),
