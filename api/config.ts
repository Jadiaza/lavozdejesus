...
export default async function handler(_req: unknown, res: ApiResponse) {
  ...
  try {
    ...
    const appearance = await optionalFirstRow(
      `
        SELECT *
        FROM lvj_cfg_apariencia
    ...
    const config = {
      ...
      color_texto_secundario: text(appearance, "color_texto_secundario"),
      color_surface: text(appearance, "color_surface"),
      color_icono: text(appearance, "color_icono"),
      color_icono_activo: text(appearance, "color_icono_activo"),
      color_icono_inactivo: text(appearance, "color_icono_inactivo"),
      color_boton_primario_fondo: text(appearance, "color_boton_primario_fondo"),
      color_boton_primario_texto: text(appearance, "color_boton_primario_texto"),
      color_boton_primario_borde: text(appearance, "color_boton_primario_borde"),
      color_boton_secundario_fondo: text(appearance, "color_boton_secundario_fondo"),
      color_boton_secundario_texto: text(appearance, "color_boton_secundario_texto"),
      color_boton_secundario_borde: text(appearance, "color_boton_secundario_borde"),
      color_nav_fondo: text(appearance, "color_nav_fondo"),
      color_nav_borde: text(appearance, "color_nav_borde"),
      color_nav_icono_activo: text(appearance, "color_nav_icono_activo"),
      color_nav_icono_inactivo: text(appearance, "color_nav_icono_inactivo"),
      color_nav_texto_activo: text(appearance, "color_nav_texto_activo"),
      color_nav_texto_inactivo: text(appearance, "color_nav_texto_inactivo"),
      color_nav_indicador: text(appearance, "color_nav_indicador"),
      color_card_texto: text(appearance, "color_card_texto"),
      color_card_icono: text(appearance, "color_card_icono"),
      color_overlay: text(appearance, "color_overlay"),
      overlay_opacidad: text(appearance, "overlay_opacidad"),
      color_input_fondo: text(appearance, "color_input_fondo"),
      color_input_borde: text(appearance, "color_input_borde"),
      color_progress_fondo: text(appearance, "color_progress_fondo"),
      color_progress_relleno: text(appearance, "color_progress_relleno"),
      color_exito: text(appearance, "color_exito"),
      color_advertencia: text(appearance, "color_advertencia"),
      color_error: text(appearance, "color_error"),
      color_info: text(appearance, "color_info"),
